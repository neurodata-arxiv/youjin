...
Also given $\{ \vartheta_{i} \}$, which are random generated from Poisson distribution, $\{ A_{ij} \}$ are i.i.d. and so $\{ P_{ij} \}$ are also i.i.d.. This argument leads to the conclusion that the observed diffusion maps $\{ U_{i} : i = 1,2,... , n \}$ are i.i.d. conditional on the unobserved uniformly distributed $\{ \vartheta_{i} \}$.
