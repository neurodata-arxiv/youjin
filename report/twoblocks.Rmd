...
$$X_{i} \sim \left\{ \begin{array}{ll}  Bern(0.3) & i \in \mbox{ block 1 } \\ Bern(0.75) & i \in \mbox{ block 2} \end{array} \right.$$
...
a <- c(0.6266667, 0.6166667, 0.5933333, 0.5433333, 0.5433333)
