...
My next assumption is that the testing results may be related to the correlation between the columns of $A \cdot B$ and the columns of $\tilde{A} \cdot \tilde{B}.$
