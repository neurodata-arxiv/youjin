...
\captionsetup{format=plain}
\centering
\subfigure[t=1]{\includegraphics[width=0.4\textwidth]{../figure/test1_1.png}}
\subfigure[t=2]{\includegraphics[width=0.4\textwidth]{../figure/test1_2.png}}
\subfigure[t=5]{\includegraphics[width=0.4\textwidth]{../figure/test1_5.png}}
\subfigure[t=10]{\includegraphics[width=0.4\textwidth]{../figure/test1_10.png}}
\caption{Estimated power when $\rho$ = 0.0}
\label{fig:test1}    
\end{figure} 


(1) $\rho = 0.2$ (10 iterations; $n = 300$)


\begin{figure}[H]
\captionsetup{format=plain}
\centering
\subfigure[t=1]{\includegraphics[width=0.4\textwidth]{../figure/test2_1.png}}
\subfigure[t=2]{\includegraphics[width=0.4\textwidth]{../figure/test2_2.png}}
\subfigure[t=5]{\includegraphics[width=0.4\textwidth]{../figure/test2_5.png}}
\subfigure[t=10]{\includegraphics[width=0.4\textwidth]{../figure/test2_10.png}}
\caption{Estimated power when $\rho$ = 0.2}
\label{fig:test2}    
\end{figure} 
