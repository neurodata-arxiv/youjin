...
(1) $\rho = 0.0$ ($M = 100$ iterations; $n = 300$)
...
\newpage
(2) $\rho = 0.2$ (100 iterations; $n = 300$)

\begin{figure}[H]
\captionsetup{format=plain}
\centering
\subfigure[t=1]{\includegraphics[width=0.4\textwidth]{../figure/gh2_1.png}}
\subfigure[t=2]{\includegraphics[width=0.4\textwidth]{../figure/gh2_2.png}}
\subfigure[t=5]{\includegraphics[width=0.4\textwidth]{../figure/gh2_5.png}}
\subfigure[t=10]{\includegraphics[width=0.4\textwidth]{../figure/gh2_10.png}}
\caption{Estimated power when $\rho$ = 0.2}
\label{fig:gh1}    
\end{figure} 
